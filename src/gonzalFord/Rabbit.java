...
public class Rabbit extends Herbivore {
	...
	private boolean selfDestruct() {
		AbstractList<Agent> enemyCoyotes = smell(2, new SmellHandler() {
			@Override
